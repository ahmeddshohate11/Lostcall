...
class Updateprofilepassword extends StatelessWidget {
  const Updateprofilepassword({super.key});
        ...
        body: Stack(
          children: [
            ...
            Positioned(
                top: 85,
                left: 40,
                child: Image.asset("assets/images/Group 135 1.png")),
            Stack(
              children: [
                Positioned(
                ...
                Positioned(
                    ...
                    child: Image.asset("assets/images/padlock 3.png")),
                // Positioned(
